        ...
        <div class="card-body">
          <table id="wo-detail" class="table table-borderless">
            ...
            <tr>
                <td><small class="text-light fw-semibold">Tanggal Mulai</small></td>
                <td class="py-1">
                  <p class="mb-0">{{  date('d-m-Y | H:i', strtotime($data->start_date)) ?? '-' }}</p>
                </td>
            </tr>
            <tr>
                <td><small class="text-light fw-semibold">Tanggal Selesai</small></td>
                <td class="py-1">
                  <p class="mb-0">{{  date('d-m-Y | H:i', strtotime($data->final_date)) ?? '-' }}</p>
                </td>
            </tr>
              @if ($data->image != null)
                <tr>
          ...
          <form action="{{ route('workorder2.update', $data->id) }}" method="POST"  class="row g-3" enctype="multipart/form-data">
            ...
            <div class="col-12">
                ...
                @if($data->unit_id == null)
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 mb-3">
                        <label class="form-label" for="creditCardMask">Tanggal Mulai</label>
                        <div class="input-group input-group-merge">
                          <input type="datetime-local" id="start_date" value="{{ $data->start_date }}" class="form-control" name="start_date"/>
                        </div>
                        @error('start_date')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                ...
                @else
                    <div class="col-xl-12 col-md-12 col-sm-12 mb-3">
                        <label class="form-label" for="creditCardMask">Tanggal Mulai</label>
                        <div class="input-group input-group-merge">
                        <input type="datetime-local" value="{{ $data->start_date }}" id="start_date" class="form-control" name="start_date"/>
                        </div>
                        @error('start_date')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 mb-3">
                        <label class="form-label" for="creditCardMask">Tanggal Selesai</label>
                        <div class="input-group input-group-merge">
                        <input type="datetime-local" value="{{ $data->final_date }}" id="final_date" class="form-control" name="final_date"/>
                        </div>
                        @error('final_date')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
