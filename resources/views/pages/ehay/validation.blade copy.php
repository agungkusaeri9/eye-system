                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12 mb-3">
                                <div class='form-group'>
                                    ...
                                    <input disabled type='text' name='remarks' id='remarks' class='form-control @error('
                                        remarks') is-invalid @enderror' value='{{ $item->remarks ?? old(' remarks') }}'>
                                    @error('remarks')
                                    <div class='invalid-feedback'>
                                        {{ $message }}
                                    </div>
            ...
            <form action="" id="formApprove" method="post">
                <div class="modal-body">
                    ...
                    <div class='form-group mb-3'>
                        ...
                        <input type='text' name='total' id='total' disabled class='form-control @error(' total')
                            is-invalid @enderror'>
                    </div>
                    <div class='form-group mb-3'>
                        <label for='nominal' class='mb-2'>Nominal Disetujui</label>
                        <input type='text' name='nominal' id='nominal' class='form-control @error(' nominal') is-invalid
                            @enderror nominal'>
                        @error('nominal')
                        <div class='invalid-feedback'>
                            {{ $message }}
