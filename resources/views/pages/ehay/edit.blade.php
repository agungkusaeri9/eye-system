                ...
                <div class="card mb-34">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 mb-3">
                                <div class='form-group'>
                                    ...
                                    employee_name') is-invalid @enderror'
                                        value="{{ $item->employee->nrp }}" disabled>
                                    @error('employee_name')
                            ...
                            <div class="col-md-4 col-sm-12 mb-3">
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='employee_name' id='employee_name'
                                        class='form-control @error('
                                    employee_name') is-invalid @enderror'
                                        disabled value="{{ $item->employee->name }}">
                                    @error('employee_name')
                                        <div class='invalid-feedback'>
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-4 col-sm-12 mb-3">
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='employee_department' id='employee_department'
                                        ...
                                        value="{{ $item->employee->department->name }}" disabled>
                            ...
                            <div class="col-md-4 col-sm-12 mb-3">
                                <div class='form-group'>
                                    <label for='status' class='mb-1'>Status
                                        ({{ $item->currentLogStatusData()->name }})</label>
                                    <input type='text' name='status' id='status'
                                        class='form-control @error(' status')
                                    is-invalid @enderror'
                                        value="{{ $item->currentLogStatusData()->notes }}" disabled>
                                    @error('status')
                                        <div class='invalid-feedback'>
                                            {{ $message }}
                                        </div>
