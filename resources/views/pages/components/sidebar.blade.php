    ...
    <ul class="menu-inner py-1">
        ...
        <li
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->is('validator') || request()->is('validator/*') ? 'active' : '' }}">
                    <a href="{{ route('validator.index') }}" class="menu-link text-white">
                        <div>Validator</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->is('customer') || request()->is('customer/*') ? 'active' : '' }}">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                {{-- Role 3: Ajukan dan List Pengajuan --}}
                @if (auth()->user()->role == 3)
